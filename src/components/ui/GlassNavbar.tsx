...
export const GlassNavbar = () => {
    ...
    return (
        ...
        >
            <GlassCard
                // 1. APPLY CONTAINER STYLES (Background, Border, Shape, Padding)
                className={cn(
                ...
                padding="none"
            >
                {/* 2. FIX: INNER FLEX CONTAINER
                   We wrap the content in this div to ensure they sit in a perfect row.
                   The 'flex' and 'gap' must be here, not on the GlassCard itself.
                */}
                <div className={cn(
