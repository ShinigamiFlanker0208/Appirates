    ...
    <main className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <section className="flex-grow flex flex-col items-center justify-center px-4 pt-32 pb-20 text-center">
          ...
          {/* Subtext */}
          <p className="max-w-2xl text-lg text-white/60 mb-12 font-mono tracking-tight leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-24">
            ...
            <Link
              href="/projects"
              className="px-10 py-4 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md text-white font-bold hover:bg-white/10 transition-all"
            >
              The Arsenal
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full px-4">
            ...
            <GlassCard className="text-left border-gray-500/20" hover padding="lg">
              ...
              <p className="text-sm text-white/40 font-mono">
                Hard-coded excellence in Kotlin and System Architecture.
              </p>
            </GlassCard>
            ...
            <GlassCard className="text-left border-gray-500/20" hover padding="lg">
              ...
              <p className="text-sm text-white/40 font-mono">
                Crafting industrial-grade glassmorphic interfaces.
              </p>
            </GlassCard>
            ...
            <GlassCard className="text-left border-gray-500/20" hover padding="lg">
              ...
              <p className="text-sm text-white/40 font-mono">
                Shipping production-ready assets to the abyss.
              </p>
            </GlassCard>
